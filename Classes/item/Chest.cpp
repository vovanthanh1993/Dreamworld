...
//                sprite->setPosition(Vec2(origin.x / Constants::scaleSizeXY() + x * Constants::TITLE_SIZE + Constants::TITLE_SIZE / 2, (map->getMapSize().height - y) * Constants::TITLE_SIZE) * Constants::scaleSizeXY());
//                sprite->setScale(0.15 * Constants::scaleSizeXY());
