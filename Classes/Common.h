...
namespace common {
	...
	public:
		...
		static float scaleYSprite();
		static float scaleXSprite();
		static float scaleSprite();
		static Vec2 scalePos(Vec2 pos);



		static const uint16 CATEGORY_PLAYER = 0x0001; // 0001 trong nhị phân
		static const uint16 CATEGORY_STICK = 0x0002;  // 0010 trong nhị phân
		static const uint16 CATEGORY_ENEMY = 0x0004;   // 0100 trong nhị phân
		static const uint16 CATEGORY_LIMIT = 0x0008; // 1000 trong nhị phân
		...
		template <typename T>
		static void scaleSprite(T* node, float ratio) {
